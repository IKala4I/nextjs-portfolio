...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Bachelor, third year student</li>
        <li>National Technical University of Ukraine
            “Igor Sikorsky Kyiv Polytechnic Institute”</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Speak Up Online English Language School</li>
      </ul>
    ),
  },
];
